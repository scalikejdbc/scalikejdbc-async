...
lazy val jasyncVersion = "1.1.7" // provided
...
lazy val core = (project in file("core")).settings(
  ...
  libraryDependencies ++= {
    Seq (
      "org.scala-lang.modules" %% "scala-java8-compat"                % "1.0.0" cross CrossVersion.for3Use2_13,
      ...
      "com.dimafeng"           %% "testcontainers-scala"              % "0.39.4"           % "test" cross CrossVersion.for3Use2_13,
