 ...
 */
private[scalikejdbc] case class SingleAsyncPostgreSQLConnection(url: String, user: String, private val password: String)
  ...
  private[scalikejdbc] val underlying: com.github.mauricio.async.db.Connection = {
    new com.github.mauricio.async.db.postgresql.PostgreSQLConnection(configuration(url, user, password))
  }
