...
object AccountId {
  implicit val AccountIdParameterBinderFactory: Binders[AccountId] =
    Binders.long.xmap(AccountId.apply, _.id)
}
...
object Account extends SQLSyntaxSupport[Account] {
  ...
  def opt(s: SyntaxProvider[Account])(rs: WrappedResultSet): Option[Account] =
    try {
